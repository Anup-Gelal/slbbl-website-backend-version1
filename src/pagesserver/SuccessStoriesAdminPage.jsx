          ...
          <div key={s.id} className="border p-4 rounded shadow">
            ...
            <div className="flex gap-2 overflow-x-auto mt-2">
              {s.images?.map((img, idx) => (
                <img key={idx} src={img} alt="" className="h-20 rounded object-cover" />
              ))}
            </div>
            <div className="mt-2 flex gap-2">
              <button onClick={() => startEditing(s)} className="bg-yellow-500 text-white px-3 py-1 rounded">Edit</button>
