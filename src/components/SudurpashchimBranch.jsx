...
const PROVINCE = "Sudurpashchim"; 

const SudurpashchimBranch = () => {
...
export default SectionWrapper(SudurpashchimBranch, "sudurpashchimbranch");
...
import { Button } from "@/components/ui/button";
import { ChevronLeft, ChevronRight, Search } from "lucide-react";
import { sudurpashchimBranches } from "../constants";
import { SectionWrapper } from "@/hoc";
...
const SudurpashchimBranch = () => {
  ...
  const filteredBranches = sudurpashchimBranches.filter((branch) =>
    branch.name.toLowerCase().includes(search.toLowerCase())
  );
